...
MODEL_NAME  = 'Experiment_Intersection_env_cs';
PB_FILE     = 'Experiment_Intersection_env.pb';
...
for iCase = 1:numCases
    ...
    in = in.setVariable('Person_Speed', Person_Speed);
    ...
    try
        ...
        resultFile = fullfile(OUTPUT_DIR, ...
            sprintf('ScenarioB_Case%02d.mat', iCase));
